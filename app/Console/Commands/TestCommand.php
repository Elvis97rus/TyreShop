    ...
    public function handle(): void
    {
        ...
        (
            ...
            'filter' => array(
                ...
                'width_min' => config('app.tyres_width_from'),
                'width_max' => config('app.tyres_width_to'),
                'height_min' => config('app.tyres_height_from'),
                'height_max' => config('app.tyres_height_to'),
                'diameter_min' => config('app.tyres_radius_from'),
                'diameter_max' => config('app.tyres_radius_to'),
            ),
            'page' => 0,
            'pageSize' => 1500,
        );
